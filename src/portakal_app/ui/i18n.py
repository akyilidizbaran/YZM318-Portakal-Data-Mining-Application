    ...
    def __init__(self):
        ...
        self._translations: dict[str, dict[str, str]] = {
            "tr": {
                ...
                "NY Times": "NY Times",
                "Fetch NY Times articles into a corpus.": "NY Times makalelerini bir korpusa aktar.",
                "PubMed": "PubMed",
                ...
                "Project documents into a 2D map.": "Belgeleri 2B haritaya yansıt.",
                ...
                "Placeholder for The Guardian text source.": "The Guardian metin kaynağı için yer tutucu.",
                "Placeholder for NY Times text source.": "NY Times metin kaynağı için yer tutucu.",
                "Placeholder for PubMed text source.": "PubMed metin kaynağı için yer tutucu.",
                "Placeholder for Twitter text source.": "Twitter metin kaynağı için yer tutucu.",
                "Placeholder for Wikipedia text source.": "Wikipedia metin kaynağı için yer tutucu.",
                "Placeholder for text preprocessing.": "Metin ön işleme için yer tutucu.",
                "Placeholder for converting a corpus into features.": "Korpusu özelliklere dönüştürmek için yer tutucu.",
